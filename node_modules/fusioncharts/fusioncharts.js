...
1)},getFirstAlpha:aa,parsePointValue:la,parseUnsafeString:Ga,parseTooltext:Ma,toPrecision:function(a,c){var e=m(10,c);return p(a*e)/e},hasTouch:F,CREDIT_HREF:k,CREDIT_STRING:"",getSentenceCase:function(a){a=a||"";return a.charAt(0).toUpperCase()+a.substr(1)},getCrispValues:function(a,c,e){var d=e%2/2;e=p(a+d)-d;a=p(a+c+d)-d-e;return{position:e,distance:a}},regescape:function(a){return a&&a.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&")},regReplaceEscape:e,getImageURL:ua,isArray:ja,
...
k=!1,g,f,S,C={exportTargetWindow:Q(D.exportTargetWindow,P?"_blank":"_self"),exportAction:D.exportAction&&"save"===D.exportAction.toString().toLowerCase()&&"save"||"download",exportFileName:Q(D.exportFileName,"ParetoAnalysis"),exportHandler:Q(D.exportHandler,T),exportParameters:Q(D.exportParameters,""),exportFormat:Q(D.exportFormat,"PNG"),exportCallBack:Q(D.exportCallBack,""),exportAtClientSide:a(D.exportAtClientSide,1)},Y=C.exportFormat.toLowerCase(),R=0,u=0,X,O=b.document,W=N.items,H=function(a){return a.match(/http:\/\/|https:\/\//)&&
...
n.exportaction.toString().toLowerCase()&&"save"||"download",exportfilename:w(n.exportfilename,"ParetoAnalysis"),exporthandler:w(n.html5exporthandler,n.exporthandler,H),exportparameters:w(n.exportparameters,a),exportformat:w(n.exportformat,"PNG"),exportcallback:w(n.exportcallback,a),exportwithimages:h(n.exportwithimages,1),exportatclientside:h(n.exportatclientside,0)};I.printOption={enabled:h(n.printshowbutton,n.showprintmenuitem,0)};I.chartMenuOptions={position:b=w(n.toolbarposition,"tr").toLowerCase(),
